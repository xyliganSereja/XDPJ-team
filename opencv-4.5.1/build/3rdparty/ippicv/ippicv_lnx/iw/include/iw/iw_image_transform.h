...
// For ippAxs45 and ippAxs135 destination image must have flipped size: dstWidth
// = srcHeight, dstHeight = srcWidth Features support:
//      Inplace mode:            no
//      64-bit sizes:            no
...
//      supported ippStsInplaceModeNotSupportedErr    doesn't support output
//      into the source buffer. In tiling mode ippStsNullPtrErr unexpected NULL
...
// This is a more simple version of iwiWarpAffine function designed specifically
// for rotation. Features support:
//      Inplace mode:            no
//      64-bit sizes:            no
//      Internal threading:      no
//      Manual tiling:           no
...
//      pointer ippStsNoErr                         no errors ippStsNoOperation
//      [warning] width or height of an image is zero ippStsWrongIntersectQuad
//      [warning] transformed source image has no intersection with the
//      destination image
IW_DECL(IppStatus)
iwiRotate(
    const IwiImage *pSrcImage, // [in]     Pointer to the source image
    ...
    IppiInterpolationType interpolation, // [in]     Interpolation method:
                                         // ippNearest, ippLinear, ippCubic
    const IwiRotateParams
        *pAuxParams, // [in]     Pointer to the auxiliary parameters structure.
                     // If NULL - default parameters will be used
    IwiBorderType border, // [in]     Extrapolation algorithm for out of image
                          // pixels: ippBorderConst, ippBorderRepl,
                          // ippBorderTransp, ippBorderInMem
...
typedef struct _IwiResizeParams {
  ...
  Ipp32u
      lanczosLobes; // Parameter for Lanczos filters. Possible values are 2 or 3
  Ipp32u antialiasing; // Use resize with anti-aliasing if possible. Use this to
                       // reduce the image size with minimization of moire
                       // artifacts
} IwiResizeParams;
...
//      definition) Manual tiling:           no IwiTile simple tiling:   yes
//      IwiTile pipeline tiling: no
// Returns:
//      ippStsInterpolationErr              interpolation value is illegal
//      ippStsSizeErr                       size fields values are illegal
...
//      pointer ippStsNoErr                         no errors ippStsNoOperation
//      [warning] width or height of an image is zero
IW_DECL(IppStatus)
iwiResize(
    const IwiImage *pSrcImage, // [in]     Pointer to the source image
    IwiImage *pDstImage,       // [in,out] Pointer to the destination image
    IppiInterpolationType
        interpolation, // [in]     Interpolation method: ippNearest, ippLinear,
                       // ippCubic, ippLanczos, ippSuper
    const IwiResizeParams
        *pAuxParams, // [in]     Pointer to the auxiliary parameters structure.
                     // If NULL - default parameters will be used
    IwiBorderType
...
//      ippStsNullPtrErr                    unexpected NULL pointer
//      ippStsNoErr                         no errors
//      ippStsNoOperation                   [warning] width or height of an
//      image is zero
IW_DECL(IppStatus)
iwiResize_InitAlloc(
    IwiResizeSpec **pSpec, // [out] Pointer to pointer to internal spec
                           // structure. Structure will be allocated here.
    IwiSize srcSize,       // [in]  Size of the source image in pixels
    ...
    IppiInterpolationType
        interpolation, // [in]  Interpolation method: ippNearest, ippLinear,
                       // ippCubic, ippLanczos, ippSuper
    const IwiResizeParams
        *pAuxParams, // [in]  Pointer to the auxiliary parameters structure. If
...
//      is not supported ippStsNoMemErr                      failed to allocate
//      memory ippStsInplaceModeNotSupportedErr    doesn't support output into
//      the source buffer ippStsContextMatchErr               internal structure
//      is not initialized or of invalid type ippStsNullPtrErr unexpected NULL
//      pointer ippStsNoErr                         no errors ippStsNoOperation
//      [warning] width or height of an image is zero
IW_DECL(IppStatus)
iwiResize_Process(
...
typedef struct _IwiWarpAffineParams {
  Ipp32f cubicBVal;  // The first parameter for cubic filters
  Ipp32f cubicCVal;  // The second parameter for cubic filters
  Ipp32u smoothEdge; // Edges smooth post-processing. Only for ippBorderTransp,
                     // ippBorderInMem
} IwiWarpAffineParams;
...
// Simplified version of warp affine function without spec structure and
// initialization Features support:
//      Inplace mode:            no
//      64-bit sizes:            no
//      Internal threading:      no
//      Manual tiling:           no
...
//      ippStsNoErr                         no errors
//      ippStsNoOperation                   [warning] width or height of an
//      image is zero ippStsWrongIntersectQuad            [warning] transformed
...
iwiWarpAffine_InitAlloc(
    IwiWarpAffineSpec **pSpec,  // [out] Pointer to pointer to internal spec
                                // structure. Structure will be allocated here.
    IwiSize srcSize,            // [in]  Size of the source image in pixels
    IwiSize dstSize,            // [in]  Size of the destination image in pixels
    IppDataType dataType,       // [in]  Image pixel type
...
//      is not supported ippStsNoMemErr                      failed to allocate
//      memory ippStsSizeErr                       size fields values are
//      illegal ippStsContextMatchErr               internal structure is not
//      initialized or of invalid type ippStsNullPtrErr unexpected NULL pointer
//      ippStsNoErr                         no errors
//      ippStsNoOperation                   [warning] width or height of an
//      image is zero ippStsWrongIntersectQuad            [warning] transformed
