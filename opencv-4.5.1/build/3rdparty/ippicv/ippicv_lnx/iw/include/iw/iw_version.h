...
#define IPP_VERSION_COMPLEX                                                    \
  (IPP_VERSION_MAJOR * 10000 + IPP_VERSION_MINOR * 100 + IPP_VERSION_UPDATE)
#define IW_VERSION_COMPLEX                                                     \
  (IW_VERSION_MAJOR * 10000 + IW_VERSION_MINOR * 100 + IW_VERSION_UPDATE)
#define IW_MIN_COMPATIBLE_IPP_COMPLEX                                          \
  (IW_MIN_COMPATIBLE_IPP_MAJOR * 10000 + IW_MIN_COMPATIBLE_IPP_MINOR * 100 +   \
