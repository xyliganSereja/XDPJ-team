...
public:
  ...
  virtual void unmap(const MapId & /*id*/) override { ++unmapCalled; }
  virtual void finalizeWrite(const Span & /*span*/) override {}
  virtual void finalizeRead(const Span & /*span*/) override {}
  virtual Size alignment(const Span & /*span*/) override { return Size{}; }
};
...
TEST(CommBuffer, DataBufferMapper) {
  ...
  memory::DynMdView<void> view(mem,
                               {util::make_dimension(16, sizeof(int)),
