...
public:
  ...
  virtual std::unique_ptr<ade::IDataBuffer>
  getBuffer(const BufferDesc &desc, const BufferPrefs &prefs) override;
  virtual void setBuffer(const ade::DataBufferView &buffer,
                         const BufferDesc &desc) override;

  ade::IDataBuffer *buff = nullptr;
};

ade::ICommChannel::BufferPrefs
TestCommChannel::getBufferPrefs(const BufferDesc &desc) {
  BufferPrefs ret;
...
std::unique_ptr<ade::IDataBuffer>
TestCommChannel::getBuffer(const BufferDesc & /*desc*/,
                           const BufferPrefs & /*prefs*/) {
  return nullptr;
}

void TestCommChannel::setBuffer(const ade::DataBufferView &buffer,
...
TEST(CommTest, CommChannelSimple) {
  ...
  ade::Graph srcGr;
  using GraphT =
      ade::TypedGraph<ade::meta::NodeInfo, ade::meta::DataObject,
                      ade::meta::CommNode, ade::meta::CommChannel,
                      ade::meta::CommConsumerCallback,
                      ade::meta::CommProducerCallback, ade::meta::Finalizers>;
  GraphT gr(srcGr);
  ...
  ade::MemoryDescriptorView view(
      desc, {ade::util::Span(0, 10), ade::util::Span(0, 10)});
  ...
  auto producerCallback =
      gr.metadata(srcNode).get<ade::meta::CommProducerCallback>().callback;
...
TEST(CommTest, CommChannelComplexDeps) {
  ...
  ade::MemoryDescriptorView srcView1(
      desc1, {ade::util::Span(0, 10), ade::util::Span(0, 30)});
  ade::MemoryDescriptor desc2(1, {20, 20});
  ade::MemoryDescriptorView srcView2(
      desc2, {ade::util::Span(0, 20), ade::util::Span(0, 20)});

  ade::MemoryDescriptorView view1(
      srcView1, {ade::util::Span(0, 10), ade::util::Span(0, 10)});
  ade::MemoryDescriptorView view2(
      srcView1, {ade::util::Span(0, 10), ade::util::Span(10, 20)});
  ade::MemoryDescriptorView view3(
      srcView1, {ade::util::Span(0, 10), ade::util::Span(20, 30)});

  ade::MemoryDescriptorView view5(
      srcView1, {ade::util::Span(0, 10), ade::util::Span(5, 15)});
  ade::MemoryDescriptorView view6(
      srcView1, {ade::util::Span(0, 10), ade::util::Span(15, 25)});

  ade::MemoryDescriptorView view7(
      srcView2, {ade::util::Span(0, 20), ade::util::Span(0, 20)});
  ...
  gr.metadata(srcImg1).set<ade::meta::CommChannel>(
      ade::meta::CommChannel{chan1});
  gr.metadata(srcImg2).set<ade::meta::CommChannel>(
      ade::meta::CommChannel{chan2});
  gr.metadata(srcImg3).set<ade::meta::CommChannel>(
      ade::meta::CommChannel{chan3});
  gr.metadata(srcImg4).set<ade::meta::CommChannel>(
      ade::meta::CommChannel{chan4});
  gr.metadata(dstImg1).set<ade::meta::CommChannel>(
      ade::meta::CommChannel{chan5});
  gr.metadata(dstImg2).set<ade::meta::CommChannel>(
      ade::meta::CommChannel{chan6});
  gr.metadata(dstImg3).set<ade::meta::CommChannel>(
      ade::meta::CommChannel{chan7});

  int consumerCallbackCalled1 = 0;
  int consumerCallbackCalled2 = 0;
  int consumerCallbackCalled3 = 0;

  gr.metadata(dstNode1).set(
      ade::meta::CommConsumerCallback{[&]() { ++consumerCallbackCalled1; }});

  gr.metadata(dstNode2).set(
      ade::meta::CommConsumerCallback{[&]() { ++consumerCallbackCalled2; }});

  gr.metadata(dstNode3).set(
      ade::meta::CommConsumerCallback{[&]() { ++consumerCallbackCalled3; }});
  ...
  ASSERT_TRUE(
      gr.metadata(srcNode1).contains<ade::meta::CommProducerCallback>());
  ASSERT_TRUE(
      gr.metadata(srcNode2).contains<ade::meta::CommProducerCallback>());
  ASSERT_TRUE(
      gr.metadata(srcNode3).contains<ade::meta::CommProducerCallback>());
  ASSERT_TRUE(
      gr.metadata(srcNode4).contains<ade::meta::CommProducerCallback>());

  auto producerCallback1 =
      gr.metadata(srcNode1).get<ade::meta::CommProducerCallback>().callback;
  auto producerCallback2 =
      gr.metadata(srcNode2).get<ade::meta::CommProducerCallback>().callback;
  auto producerCallback3 =
      gr.metadata(srcNode3).get<ade::meta::CommProducerCallback>().callback;
  auto producerCallback4 =
      gr.metadata(srcNode4).get<ade::meta::CommProducerCallback>().callback;
