...
static_assert(ade::util::details::has_size_fun<TestHasSize1>::value == false,
              "TestHasSize1");
static_assert(ade::util::details::has_size_fun<TestHasSize2>::value == false,
              "TestHasSize2");
static_assert(ade::util::details::has_size_fun<TestHasSize3>::value == true,
              "TestHasSize3");
