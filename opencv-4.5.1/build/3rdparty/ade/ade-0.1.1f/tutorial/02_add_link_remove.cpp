...
int main(int argc, char *argv[]) {
...

  {
    ...
    n1 = graph.createNode();
    std::cout << "After 1st .createNode() [n1=" << n1 << "], there\'re "
              << graph.nodes().size() << " node(s)" << std::endl;

    n2 = graph.createNode();
    std::cout << "After 2nd .createNode() [n2=" << n2 << "], there\'re "
              << graph.nodes().size() << " node(s)" << std::endl;
    ...
    graph.erase(n1);
    std::cout << "After erase(), there\'re " << graph.nodes().size()
              << " node(s)" << std::endl;
  ...
  std::cout << std::endl;
  std::cout << "After graph destruction: n1=" << n1 << ", n2=" << n2
            << ", e=" << e << std::endl;
